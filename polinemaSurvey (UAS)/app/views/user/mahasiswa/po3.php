          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4>P03 Layanan Politeknik Negeri Malang</h4>
                <h5>Kategori ini menilai kualitas layanan yang diberikan oleh berbagai unit di kampus Polinema, seperti administrasi akademik, pusat informasi, layanan kesehatan, bimbingan karir, dan sebagainya. Pelayanan yang efisien, responsif, dan mendukung kebutuhan civitas akademika sangat penting untuk memastikan kelancaran kegiatan akademik dan non-akademik. Kategori ini membantu mengidentifikasi area yang perlu ditingkatkan dalam hal pelayanan kepada mahasiswa, dosen, tenaga kependidikan, dan pemangku kepentingan lainnya.
</h5>
                <br>
                <br>
                <br>
              ...
              <br>
              <br>
              <form action ="../../../controller/responden/mahasiswa/tambahJawaban.php" method="post">
              <div class="question-container">
             <div>
             <div class = "question-navbar">P03 Layanan Politeknik Negeri Malang</div>

                      <input type="hidden" name="survey_id" value="<?php echo $survey_id; ?>">
                      <input type="hidden" name="kategori_id" value="<?php echo $kategori_id; ?>">
                     
                      <?php
                      $soalList = $crud -> readSoalMahasiswa ($survey_id, $kategori_id);
                      $no = 1; // Nomor urut
