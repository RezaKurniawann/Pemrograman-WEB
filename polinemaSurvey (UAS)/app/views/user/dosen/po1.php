          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4>P01 Pengajaran Politeknik Negeri Malang</h4>
                <h5>Kategori ini mencakup pertanyaan-pertanyaan yang bertujuan untuk menilai kualitas dan efektivitas proses belajar mengajar di kampus Polinema. Aspek yang dinilai meliputi relevansi kurikulum, kompetensi dosen, metode pembelajaran, ketersediaan bimbingan akademik, serta dukungan untuk penelitian. Kategori ini penting untuk memastikan bahwa kampus Polinema dapat memberikan memberikan pendidikan yang berkualitas dan mempersiapkan mahasiswa dengan baik untuk karir mereka di masa depan.
</h5>
                <br>
                <br>
                <br>
             ...
             <div>
             <div class = "question-navbar">P01 Kualitas Pendidikan Politeknik Negeri Malang</div>
