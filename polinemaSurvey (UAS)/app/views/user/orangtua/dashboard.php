            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  <tbody>
                  <div class="kategori">
                    <a href="../../user/orangtua/po1.php"> 
                        <img src="../../../../public/image/pendidikan.png">
                    </a> 
                    <a href = "../../user/orangtua/po2.php"> 
                        <img src="../../../../public/image/fasilitas.png">
                    </a>
                    <a href="../../user/orangtua/po3.php">  
                        <img src="../../../../public/image/pelayanan.png">
                    </a>
                    <a href="../../user/orangtua/po4.php">  
                        <img src="../../../../public/image/lulusan.png">
                    </a>
                </div>  
              </tbody>
                </table>
