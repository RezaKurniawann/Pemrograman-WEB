          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h4>P02 Layanan Politeknik Negeri Malang</h4>
              ...
              <br>
              <br>
              <form action ="../../../controller/responden/industri/tambahJawaban.php" method="post">
              <div class="question-container">
             <div>
             <div class = "question-navbar">P02 Layanan Politeknik Negeri Malang</div>
                      <input type="hidden" name="survey_id" value="<?php echo $survey_id; ?>">
                      <input type="hidden" name="kategori_id" value="<?php echo $kategori_id; ?>">
                     
                      <?php
                      $soalList = $crud -> readSoalIndustri ($survey_id, $kategori_id);
                      $no = 1; // Nomor urut
