                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        $kategoriList = $crud->readKategoriIndustri($user_id);
                        $no = 1;
                        foreach ($kategoriList as $kategori) {
                          echo "<tr>";
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $kategori['survey_nama'] . "</td>";
                          echo "<td>" . ($kategori['survey_tanggal'] ? $kategori['survey_tanggal'] : '') . "</td>";
                          echo "<td class='text-center align-middle'>";
                          if ($kategori['survey_tanggal']) {
                              echo "sudah terisi";
                          } else {
