    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <h1 class="m-0" style = "color : #2c4182">Alumni</h1>
        </div><!-- /.container-fluid -->
      </div>
      <!-- /.content-header -->
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        $alumniList = $crud->readAlumni();
                        $no = 1; // Nomor urut
                        foreach ($alumniList as $alumni) {
                          echo "<tr>";
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $alumni['nama'] . "</td>";
                          echo "<td>" . $alumni['username'] . "</td>";
                          echo "<td>" . $alumni['password'] . "</td>";
                          echo "<td>" . $alumni['responden_nim'] . "</td>"; 
                          echo "<td>" . $alumni['responden_prodi'] . "</td>"; 
                          echo "<td>" . $alumni['responden_hp'] . "</td>"; 
                          echo "<td>" . $alumni['tahun_lulus'] . "</td>"; 
                          echo '<td class="text-center align-middle">
                                  <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEdit" onclick="fillEditFormAlumni(' . htmlspecialchars(json_encode($alumni)) . ')">
                                    <i class="fas fa-edit"></i> Edit
                                  </button>
                                  <form action="../../../controller/responden/alumni/alumni_delete.php" method="POST" style="display:inline-block;">
                                    <input type="hidden" name="user_id" value="' . $alumni['user_id'] . '">
                                    <input type="hidden" name="responden_id" value="' . $alumni['responden_alumni_id'] . '">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modalEditLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="editForm" action="../../../controller/responden/alumni/alumni_edit.php" method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="edit_tahun_lulus" name="tahun_lulus" required>
          </div>
        </div>
