...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <h1 class="m-0" style = "color : #2c4182">Industri</h1>
        </div><!-- /.container-fluid -->
      </div>
      <!-- /.content-header -->
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card-header">
                <h3 class="card-title">Daftar Industri</h3>
              </div>
              <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                      ...
                      $industriList = $crud->readIndustri();
                      $no = 1; // Nomor urut
                      foreach ($industriList as $industri) {
                          echo "<tr>";
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . $industri['nama'] . "</td>"; 
                          echo "<td>" . $industri['username'] . "</td>"; 
                          echo "<td>" . $industri['password'] . "</td>"; 
                          echo "<td>" . $industri['responden_jabatan']. "</td>";
                          echo "<td>" . $industri['responden_perusahaan']. "</td>";
                          echo "<td>" . $industri['responden_hp']. "</td>";
                          echo "<td>" . $industri['responden_kota']. "</td>";
                          echo '<td class="text-center align-middle">
                                  <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEdit" onclick="fillEditFormIndustri(' . htmlspecialchars(json_encode($industri)) . ')">
                                    <i class="fas fa-edit"></i> Edit
                                  </button>
                                  <form action="../../../controller/responden/industri/industri_delete.php" method="POST" style="display:inline-block;">
                                    <input type="hidden" name="user_id" value="' . $industri['user_id'] . '">
                                    <input type="hidden" name="responden_id" value="' . $industri['responden_industri_id'] . '">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="editForm" action="../../../controller/responden/industri/industri_edit.php" method="POST">
