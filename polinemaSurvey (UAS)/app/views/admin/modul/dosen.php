...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <h1 class="m-0" style = "color : #2c4182">Dosen</h1>
        </div><!-- /.container-fluid -->
      </div>
      <!-- /.content-header -->
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach ($dosenList as $dosen) {
                          ...
                          echo "<td>" . $dosen['password'] . "</td>"; 
                          echo "<td>" . $dosen['responden_nip']. "</td>";
                          echo "<td>" . $dosen['responden_unit'] . "</td>";
                          echo '<td class="text-center align-middle">
                                  <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEdit" onclick="fillEditFormDosen(' . htmlspecialchars(json_encode($dosen)) . ')">
                                    <i class="fas fa-edit"></i> Edit
                                  </button>
                                  <form action="../../../controller/responden/dosen/dosen_delete.php" method="POST" style="display:inline-block;">
                                    <input type="hidden" name="user_id" value="' . $dosen['user_id'] . '">
                                    <input type="hidden" name="responden_id" value="' . $dosen['responden_dosen_id'] . '">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="editForm" action="../../../controller/responden/dosen/dosen_edit.php" method="POST">
