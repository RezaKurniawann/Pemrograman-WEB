...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $responden_ortu_id = $_SESSION['responden_id'];
    ...
    if ($allAnswered) {
        ...
        $conn->close();
        echo '<script>alert("Terima kasih telah mengisi survey!"); window.location.href = "../../../views/user/orangtua/dashboard.php";</script>';
        exit;
    } else {
        echo '<script>alert("Gagal mengisi survey, harap isi seluruh jawaban!"); window.location.href = "../../../views/user/orangtua/dashboard.php";</script>';
        exit;
    }
}
?>
