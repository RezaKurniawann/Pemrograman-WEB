...
<body>
    <div class="container">
        <h2>Data Anggota</h2>
        <a href="../CRUDread/creat.php" class="btn-tambah">Tambah Anggota</a>
        <?php
        include('koneksi.php');
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<tr>
                      ...
                      <td>" . $row["no_telp"] . "</td>
                      <td><a href='../CRUDread/edit.php?id=" . $row["id"] . "'>Edit</a> |
    ...
    <script>
        function konfirmasiHapus(id, nama) {
            ...
            if (konfirmasi) {
                window.location.href = "../CRUDread/proses.php?aksi=hapus&id=" + id;
            }
        }
    </script>
</body>
